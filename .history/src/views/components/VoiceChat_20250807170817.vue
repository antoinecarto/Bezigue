...
// ✅ FONCTION PRINCIPALE - Exposée pour le template
...
const handleCaller = async () => {
  try {
    ...
    // ✅ CORRECTION: Utiliser updateDoc avec des chemins spécifiques
...
const setupCandidatesListener = async () => {
  if (!isValidRoomId.value) {
...
// ✅ FONCTION EXPOSÉE pour le template
