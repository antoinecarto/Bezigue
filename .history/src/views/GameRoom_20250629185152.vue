...
async function drawCard() {
  ...
  await runTransaction(db, async (tx) => {
    ...
    const nextHand = [...d.hands[myUid.value], card]; // ou push/echange
    if (!checkDoubleDeckLimit(nextHand, d.melds?.[myUid.value] ?? []))
      throw "Pioche impossible : vous auriez plus de deux exemplaires identiques.";
