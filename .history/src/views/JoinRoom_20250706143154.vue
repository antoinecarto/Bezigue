...
async function maybeStartGame(tx: any, roomRef: any, roomData: any) {
  ...
  // Simule une fonction de création de deck mélangé et distribution
  ...
  function distributeCards(deck: string[]) {
    // Distribue moitié moitié
    return {
      hands: {
        player1: deck.slice(0, 16),
        player2: deck.slice(16, 32),
      },
      drawPile: deck.slice(32),
