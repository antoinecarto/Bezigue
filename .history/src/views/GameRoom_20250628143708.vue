...
watchEffect(() => {
  ...
  if (combos.length) {
    ...
    /* 5. Aucune combinaison → on passe directement à la pioche */
    forceEndMeldPhase();
    askedCombiThisTrick.value = true;
  }
});
