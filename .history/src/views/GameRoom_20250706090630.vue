...
import { SortableContext, useDroppable, useDraggable } from "@vue-dnd-kit/core";
...
import {
  detectCombinations,
  type Combination,
} from "@/game/types/detectCombinations";
import { cardToStr, baseCode } from "@/game/utils/cardHelpers";
