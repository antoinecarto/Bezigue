  ...
  <div class="game-room text-center p-4">
    ...
    <div v-if="opponentHand.length" class="player-hand mt-6">
      ...
      <div class="cards flex gap-2 justify-center flex-wrap">
        <Card :card="'/back.svg'" :width="60" :height="90" />
      </div>
    ...
    <div v-if="localHand.length" class="player-hand mt-8">
      ...
      <div class="mt-4">
        <draggable
          ...
          :item-key="cardToStr"
          style="min-width: 200px; min-height: 120px; border: 1px solid red"
        >
...
.card {
  ...
  display: inline-block; /* pour respecter les dimensions inline */
}
...
.cards {
  min-width: 200px; /* ou une valeur adaptée */
  min-height: 120px; /* au moins la hauteur d’une carte */
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
