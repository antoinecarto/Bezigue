...
/* --- distribution des cartes (inchangé) --- */
const deckInfo = distributeCards(generateShuffledDeck());


  /* mains : clef = UID, valeur = tableaux de cartes */
  hands: {
    [uid]: deckInfo.player1Hand
  },

  /* on garde la main de l’adversaire pour plus tard */
  reservedHands: {
  ...
  /* optionnel : table de correspondance UID → alias/pseudo */
  aliases: {
    [uid]: aliasId
  }
};
