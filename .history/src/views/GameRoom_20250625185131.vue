...
watch(
  ...
  (newId, oldId) => {
    ...
    // coupe l’écoute précédente
    if (unsubscribeMene) {
      unsubscribeMene()
      unsubscribeMene = null
    }
    // démarre l’écoute de la nouvelle mène
    unsubscribeMene = subscribeMene(roomId, newId)
  },
  { immediate: true }
)
