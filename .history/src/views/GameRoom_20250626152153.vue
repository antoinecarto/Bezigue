<template>
  <div class="game-room text-center p-4">
   ...
   <!-- Conteneur principal : tout tient sur une ligne -->
<div class="mt-12 flex justify-center gap-8">

  <!-- Scoreboard -->
  <div
    class="scoreboard flex flex-col items-center gap-4 p-4 border-2 border-gray-300 rounded-lg shadow-md w-48"
  >
  ...
  <div class="flex flex-col items-center">
    <span class="text-sm text-gray-600 mb-1">Atout</span>
    <div
    ...
    <span class="text-gray-700 text-sm italic text-center">
