...
const createRoom = async () => {
  ...
  try {
    ...
    /* --- 3. Données Firestore ----------------------- */
//
const player1Id = uid;  // l'UID du premier joueur (connecté)
const player2Id = 'player-eb1db9f0-4a3d-4a38-b33d-425a2d6bf369';  // ou récupéré d'ailleurs
...
const roomData = {
  ...
  hands: {
    [player1Id]: deckInfo.hands.player1,
    [player2Id]: deckInfo.hands.player2
  }
};
